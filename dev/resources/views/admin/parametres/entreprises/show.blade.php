    ...
    <div class="card-body">
      <div class="row">
        <div class="col-lg-8">
          ...
          <a class="btn btn-info btn-sm px-3 ms-2" href="{{route('admin.client.edit', $Entreprise->id)}}">{{__('messages.edit')}}</a>
      ...
      <div class="card mb-3">
                ...
                <div class="card h-100" id="table" data-list="{&quot;valueNames&quot;:[&quot;path&quot;,&quot;views&quot;,&quot;time&quot;,&quot;exitRate&quot;],&quot;page&quot;:8,&quot;pagination&quot;:true,&quot;fallback&quot;:&quot;pages-table-fallback&quot;}">
                    ...
                    <div class="row flex-between-center">
                        ...
                        <h6 class="mb-0 text-nowrap py-2 py-xl-0">Activités de cette entreprise</h6>
                        </div>
