    ...
    <div class="col-span-12 lg:col-span-12 xxl:col-span-12">
        ...
        <div class="intro-y flex flex-col-reverse sm:flex-row items-center">
            ...
            <div class="w-full sm:w-auto flex">
                <a href="{{route('taxes.create')}}" class="btn btn-primary shadow-md mr-2"><i class="w-4 h-4 mr-2"
                        data-feather="plus"></i>Ajouter taxe</a>
            </div>
        </div>
                ...
                <div class="intro-y box p-5">
                    <form action="{{ route('taxes.update',$taxe->id)}}" method="POST">
                        ...
                        <div class="m-2 mb-3">
                            ...
                            <input id="crud-form-1" type="text" name="nom" value="{{ $taxe->nom }}"
                        ...
                        <div class="m-2 mb-3">
                            ...
                            <input id="crud-form-2" name="taux" value="{{ $taxe->taux }}" type="number" class="form-control w-full @error('taux') is-invalid @enderror"
