    ...
    <div class="col-lg-12 pe-lg-2">
      <div class="card mb-3">
        ...
        <div class="card-body">
           ...
           <form action="{{route('entreprise.models-contrat.store')}}" class="row g-3 needs-validation" novalidate="" method="POST" > @csrf
            ...
            <div class="col-md-4-12">
                ...
                <textarea name="contenu" id="summary-ckeditor" class="form-control" id="" cols="30" rows="10"></textarea>
            </div>
