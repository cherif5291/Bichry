...
<div class="intro-y box p-5 mt-5">
    <form action="{{ route('articles.update', $article->id)}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="m-2 mb-3">
            ...
            <input id="crud-form-1" type="text" name="nom" value="{{ old('nom', $article->nom)}}"
        ...
        <div class="m-2 mb-3">
            ...
            <textarea id="crud-form-1" type="text" name="description"
                class="form-control w-full @error('description') is-invalid @enderror" placeholder="Ex: BICIS">{{ old('decription', $article->description)}}</textarea>
            @error('description')
            <span class="invalid-feedback" style="color: red" role="alert">
                <strong>{{ $message }}</strong>
            </span>
        ...
        <div class="m-2 mb-3">
            ...
            <input id="crud-form-2" name="prix_unitaire" value="{{ old('prix_unitaire', $article->prix_unitaire)}}" type="number" class="form-control w-full @error('prix_unitaire') is-invalid @enderror"
        ...
        <div class="m-2 mb-3">
            <label for="crud-form-2" class="form-label">Quantité <span
                    class="text-danger" style="color: red">*</span></label>
            <input id="crud-form-2" name="quantite" value="{{ old('quantite', $article->quantite)}}" type="number" class="form-control w-full @error('quantite') is-invalid @enderror"
                placeholder="Ex: 1248791499864">
                @error('quantite')
            <span class="invalid-feedback" style="color: red" role="alert">
                <strong>{{ $message }}</strong>
        ...
        <div class="m-2 mb-3">
            ...
            <input id="crud-form-3" type="file" name="image" value="{{ old('image', $article->image)}}" class="form-control w-full @error('image') is-invalid @enderror"
        ...
        <div class="text-right mt-5">
            ...
            <button type="submit" class="btn btn-primary w-24">Modifier</button>
        </div>
    </form>
</div>
@endsection
