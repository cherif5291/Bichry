      ...
      <div class="card h-100">
        ...
        <form action="{{route('entreprise.depense.changeDepenseSatus', $Depense->id)}}" method="POST">@csrf
            <div class="row col-md-12 d-flex justify-content-between gx-3 mb-3">
                <div class="col-md-6">
                  <label class="form-label ls text-uppercase text-600 fw-semi-bold mb-0 fs--1" for="fournisseur">Fournisseurddd</label>
              ...
              <div class="row gx-3 col-md-12 d-flex justify-content-between mb-3">
                ...
                <div class="col-md-4">
                    ...
                    <input class="form-control datetimepicker" name="date_paiement" id="date_paiement" value="@if ($Cheque){{$Cheque->date_paiement}}  @endif"   type="date" />
                </div>

              </div>
            {{-- @dd($Cheque->adresse_postale) --}}
              <div class="row gx-3 col-md-12 d-flex justify-content-between  mb-3">
                <div class="col-md-6">
                    <label class="form-label ls text-uppercase text-600 fw-semi-bold mb-0 fs--1" for="adresse_postale">Addresse Postale</label>
                        <input class="form-control" id="adresse_postale" name="adresse_postale" type="text" value=" @if ($Cheque) {{$Cheque->adresse_postale}} @endif" />
                </div>
                <div class="col-md-4">
                    <label class="form-label ls text-uppercase text-600 fw-semi-bold mb-0 fs--1" for="numero_cheque">Nº de cheque</label>
                    <input class="form-control" id="numero_cheque" name="numero_cheque" type="text" value=" @if ($Cheque) {{$Cheque->numero_cheque}} @endif" />
                </div>
              ...
              <div class="row gx-3 col-md-12 d-flex justify-content-between mb-3">
                ...
                <div class="col-md-8">
                    ...
                    <textarea name="note" id="" class="form-control" cols="30" id="note" rows="4"> @if ($Cheque) {{$Cheque->note}} @endif</textarea>
                </div>
                <div class="col-md-4">
                   <div>
