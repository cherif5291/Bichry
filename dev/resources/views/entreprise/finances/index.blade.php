    ...
    <div class="col-lg-4 pe-lg-2">
        <div class="card h-100">
            ...
            <ul class="nav nav-tabs py-1" id="myTab" role="tablist"  style="background-color: #232e3c">
                <li class="nav-item"><a class="nav-link text-light active" id="home-tab" data-bs-toggle="tab" href="#tab-home" role="tab" aria-controls="tab-home" aria-selected="true">{{__('messages.cash_account')}}</a></li>
                        ...
                        <table class="table fs--1 mb-0 overflow-hidden">
                          ...
                          <tbody>
                              ...
                              <tr>
                                ...
                                <td class="text-truncate text-start">
                                    <a href="{{route('entreprise.finances.caisse',$banque->id )}}"> <i class="far fa-eye"></i></a>
                                </td>
                              </tr>
                              @endforeach
    ...
    <div class="col-lg-8 ps-lg-2">
        <div class="card h-100">
            <div class="card-header d-flex flex-between-center  py-2"  style="background-color: #232e3c">
              <h6 class="mb-0 text-light">{{__('messages.financial_activity')}}</h6>
                ...
                <div class="row">
                    <div class="col-1 p-3 m-1 card h-100 bg-dark">
                        <div>
                            ...
                            <h3 class="fw-normal text-700" style="color: white !important">0</h3>
                        </div>
                        </div>
                    <div class="col-4 p-3 m-1 card h-100 bg-line-chart-gradient">
                      <div>
                        ...
                        <h3 class="fw-normal text-700" style="color: white !important">{!! formatpriceth(0, getCurrency()) !!}</h3>
                      </div>
                    </div>
                    ...
                    <tbody>
                      <tr>
                        <td class="w-100" colspan="5">
                            <strong class="text-warning"> <i class="fas fa-exclamation-triangle"></i>
                                {{__('messages.cash_bank_tips')}}
                                {{-- Vous devez selectionner une caisse ou une banque dans le tableau à coté pour avoir les détails de transactions lié. --}}
                            </strong>
                        </td>
