    ...
    <div class="col-lg-4 pe-lg-2">
        <div class="card h-100">
            <ul class="nav nav-tabs py-1" id="myTab" role="tablist"  style="background-color: #232e3c">
                <li class="nav-item"><a class="nav-link active" id="home-tab" data-bs-toggle="tab" href="#tab-home" role="tab" aria-controls="tab-home" aria-selected="true">{{__('messages.cash_account')}}</a></li>
                <li class="nav-item"><a class="nav-link" id="profile-tab" data-bs-toggle="tab" href="#tab-profile" role="tab" aria-controls="tab-profile" aria-selected="false">{{__('messages.banks_account')}}</a></li>
            </ul>
                        ...
                        <table class="table fs--1 mb-0 overflow-hidden">
                          ...
                          <tbody>
                              ...
                              <tr>
                                ...
                                <td class="text-truncate">{{$caisse->solde}}$</td>
                        ...
                        <table class="table fs--1 mb-0 overflow-hidden">
                          ...
                          <tbody>
                              ...
                              <tr>
                                ...
                                <td class="text-truncate">{{$banque->solde}}$</td>
                                <td class="text-truncate text-start">
    ...
    <div class="col-lg-8 ps-lg-2">
        <div class="card h-100">
            <div class="card-header d-flex flex-between-center  py-2"  style="background-color: #232e3c">
                <h6 class="mb-0">Activité financière sur le compte <strong class="text-danger">{{$Banque->nom}}</strong></h6>
              ...
              <div class="row">
                ...
                <div class="col-4 p-3 m-1 card h-100 bg-line-chart-gradient">
                  <div>
                    ...
                    <h3 class="fw-normal text-700" style="color: white !important">{{$Banque->solde}}$</h3>
                  </div>
                </div>
                <div class="col-3 p-3 m-1 card h-100 bg-danger">
                  <div>
                    <h6 class="text-700" style="color: white !important">{{__('messages.debited_today')}}</h6>
                    <h3 class="fw-normal text-700" style="color: white !important">{{$Transactions->where('type', "debit")->where('created_at', $Today)->sum('montant')}}$</h3>
                  </div>
                </div>
                <div class="col-3 p-3 m-1 card h-100 bg-success">
                    <div>
                      <h6 class="text-700" style="color: white !important">{{__('messages.credited_today')}}</h6>
                      <h3 class="fw-normal text-700" style="color: white !important">{{$Transactions->where('type', "credit")->where('created_at', $Today)->sum('montant')}}$</h3>
                    </div>
                  </div>
                  ...
                  <table class="table fs--1 mb-0 overflow-hidden">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-truncate text-end">{!! formatpriceth($transaction->pre_solde_banque, getCurrency()) !!}</td>
                            <td class="text-truncate text-end">{!! formatpriceth($transaction->montant, getCurrency()) !!}</td>
                            <td class="text-truncate text-end">{!! formatpriceth($transaction->post_solde_banque, getCurrency()) !!}</td>
