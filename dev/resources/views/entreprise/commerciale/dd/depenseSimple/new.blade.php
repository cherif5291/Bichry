        ...
        <form action="{{route('entreprise.depense.changeDepenseSatus', $Depense->id)}}" method="POST">@csrf
            <div class="row col-md-12 d-flex justify-content-between gx-3 mb-3">
              ...
              <div class="row gx-3 col-md-12 d-flex justify-content-between mb-3">
                <div class="col-md-6">
                  <label class="form-label ls text-uppercase text-600 fw-semi-bold mb-0 fs--1" for="paiementsource_id">Compte de paidddement</label>
                  <select class="form-select mb-3" name="paiementsource_id" id="paiementsource_id" aria-label="Default select example">
                    <option >Compte de paiement</option>
                ...
                <div class="col-md-4">
                    ...
                    <input class="form-control" name="date_facturation" id="date_facturation" value=" @if ($DepenseSimple){{$DepenseSimple->date_paiement}}  @endif"   type="date" />
                </div>
