    ...
    <div class="card-header">
        <div class="row flex-between-end">
            <div class="col-auto align-self-center">
                <h5 class="mb-0" data-anchor="data-anchor">{{$Fournisseur->entreprise}}</h5>
            </div>
            ...
            <div class="tab-pane preview-tab-pane active" role="tabpanel"
                ...
                <form action="{{route('entreprise.fournisseurs.update', $Fournisseur->id)}}" class="row g-3 needs-validation" novalidate="" method="POST" enctype="multipart/form-data"> @csrf
                    ...
                    <div class="col-md-4">
                        ...
                        <input class="form-control" name="prenom" id="prenom" type="text" value="{{$Fournisseur->prenom}}" required="" />
                    </div>
                    <div class="col-md-4">
                        <label class="form-label" for="nom">Nom du responsable</label>
                        <input class="form-control" name="nom" id="nom" type="text" value="{{$Fournisseur->nom}}" required="" />
                    </div>
                    <div class="col-md-4">
                        <label class="form-label" for="titre">Titre du responsable</label>
                        <input class="form-control" name="titre" id="titre" type="text" value="{{$Fournisseur->titre}}" required="" />
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <input class="form-control" name="email" id="email" type="text" value="{{$Fournisseur->email}}"/>
                    </div>
