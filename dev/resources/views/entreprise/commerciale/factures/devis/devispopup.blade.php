...
<input type="hidden" id="id-devis" />
<input hidden class="form-control" name="type" id="type-devis" type="text" value="devis" />
        ...
        <form method="" action="">
            <div class="row col-md-12 d-flex justify-content-between gx-3 mb-3">
                <div class="d-flex mb-4 justify-content-between">
                    <h4>{{__('messages.invoice')}} {{__('messages.no')}} <span id="devis_number_com_update" style="color: red!important"></span></h4>
                    <div>
                        <button class="btn btn-success btn-devis-com-submit">{{__('messages.update')}} </button>
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item text-danger" id="id_delete_devis" href="{{route('devis.destroy', '#')}}" style="font-weight: 900">Confirmer la
            ...
            <div class="row col-md-12 d-flex justify-content-start gx-3 mb-3">
                ...
                <div class="col-md-2 col-6 d-none d-md-block">
                   ...
                   <h3 id="amount_commercial_devis_pay_update">{{getCurrency()->sigle}} 0.00</h3>
                </div>
            </div>
            ...
            <div class="row gx-3 col-md-12 d-flex justify-content-start mb-3">
                ...
                <input name="type" value="devis" hidden/>
                <div class="col-md-4 col-6 d-md-block d-none"></div>

                <div class="col-md-2 col-6">
                    <label class="form-label ls text-uppercase text-600 fw-semi-bold mb-0 fs--1" for="numero_devis">{{__('messages.invoice')}} {{__('messages.no')}}</label>
                    <input class="form-control" id="numero_devis_update" name="numero_devis" type="number"  />
                </div>
            ...
            <div class="col-md-12">
                <div class="table-responsive scrollbar mt-4 fs--1">
                    <table id="test-table"  class="table table-striped border-bottom">
                        ...
                        <tbody style="padding: 0px !important; margin: 0px !important" class="table-categorie-devis-com">
                    ...
                    <div class="modal fade" id="staticBackdrop" data-bs-keyboard="false" data-bs-backdrop="static" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg mt-6" role="document">
                            ...
                            <div class="modal-body  p-0 bg-light" >
                                ...
                                <div class="">
                                    <iframe id="pj_devis_devis" src="#" width="100%" height="600px"> </iframe>
                                </div>
                            </div>
                            </div>
                        </div>
                    ...
                    <div class="col-auto mt-3">
                        <table class="table table-sm table-borderless fs--1 text-end t-edit" id="t-edit">
                            <tr>
                                ...
                                <td class="fw-semi-bold text-light" id="total_sans_taxe_devis">0.00 {{getCurrency()->sigle}}</td>
                                <input class="total_sans_taxe_devis " id="tot_ht" hidden/>
                            </tr>
                            <tr>
                                <th class="text-light t_taxe_devis" id="taux_taxe_devis">{{__('messages.taxe_amount')}} :</th>
                                <input class="text-light taux_taxe_devis" hidden/>
                                <td class="fw-semi-bold text-light " id="taxe_devis">0 {{getCurrency()->sigle}}</td>
                                <input class="taxe_devis" hidden id="tot_taxe"/>
                            </tr>

                            <tr class="border-top border-top-2 fw-bolder text-light">
                                <th>{{__('messages.amount_to_paye')}}:</th>
                                <td id="total_devis">0 {{getCurrency()->sigle}}</td>
                                <input class="total_devis" hidden id="tsanstaxe"/>
                            </tr>
                        </table>
                    </div>
                </div>
                ...
                <div class="p-4 pb-0">
                    <form action="{{route('entreprise.fournisseurs.new.store')}}" class="row g-3 needs-validation"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                <label class="form-label" for="nom_pro">Nom sur les devis</label>
