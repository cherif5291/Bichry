    ...
    <div class="card-body">
      <div class="row">
        <div class="col-lg-8">
          ...
          <h5 class="fs-0 fw-normal">{{__('messages.represented_by')}}: {{$Client->prenom}} {{$Client->nom}} | {{$Client->titre}}</h5>
          ...
          <a class="btn btn-info btn-sm px-3 ms-2" href="{{route('entreprise.client.edit', $Client->id)}}">{{__('messages.edit')}}</a>
          @else
