    ...
    <div class="grid grid-cols-12 gap-6 mt-8">
        <div class="col-span-12 lg:col-span-3 xxl:col-span-2">
            ...
            <div class="intro-y box p-5 mt-0">
                <div class="">
                    <a href="#banque" class="flex items-center px-3 py-2 rounded-md bg-theme-17 text-white font-medium"> <i class="w-4 h-4 mr-2" data-feather="image"></i> Banque </a>
        ...
        <div class="col-span-12 lg:col-span-9 xxl:col-span-10">
            ...
            <div class="intro-y flex flex-col-reverse sm:flex-row items-center">
                <div class="w-full sm:w-auto relative mr-auto mt-3 sm:mt-0">
                    ...
                    <input type="text" class="form-control w-full sm:w-64 box px-10 text-gray-700 dark:text-gray-300 placeholder-theme-8" placeholder="Recherche banque">
                ...
                <div class="w-full sm:w-auto flex">
                    <a href="{{route('banques.create')}}" class="btn btn-primary shadow-md mr-2"><i class="w-4 h-4" data-feather="plus"></i>Ajouter banque</a>
                </div>
            </div>
            <!-- END: File Manager Filter -->
            <!-- BEGIN: Directory & Files -->
            <div class="intro-y grid grid-cols-12 gap-3 sm:gap-6 mt-5" id="banque">
                @forelse($banques as $banque)
                <div class="intro-y col-span-6 sm:col-span-4 md:col-span-3 xxl:col-span-2">
                    <div class="file box rounded-md px-5 pt-8 pb-5 px-3 sm:px-5 relative zoom-in">

                        <a href="" class="w-3/5 file__icon file__icon--empty-directory mx-auto"></a> <a href="" class="block font-medium mt-4 text-center truncate">{{ $banque->nom ?? '-' }}</a>
                        <div class="text-gray-600 text-xs text-center mt-0.5">{{ $banque->numero_compte ?? '-' }}</div>
                        <div class="absolute top-0 right-0 mr-2 mt-2 dropdown ml-auto">
                            ...
                            <div class="dropdown-menu w-40">
                                <div class="dropdown-menu__content box dark:bg-dark-1 p-2">
                                    {{-- @can('update', $banque) --}}
                                    <a href="{{ route('banques.edit', $banque) }}" class="flex items-center block p-2 transition duration-300 ease-in-out bg-white dark:bg-dark-1 hover:bg-gray-200 dark:hover:bg-dark-2 rounded-md"> <i data-feather="edit" class="w-4 h-4 mr-2"></i> Modifier </a>
                                    {{-- @endcan
                                    @can('delete', $banque) --}}
                                    <form
