    ...
    <div class="col-span-12 lg:col-span-12 xxl:col-span-12">
        ...
        <div class="intro-y flex flex-col-reverse sm:flex-row items-center">
            ...
            <div class="w-full sm:w-auto flex">
                <a href="{{route('banques.create')}}" class="btn btn-primary shadow-md mr-2"><i class="w-4 h-4 mr-2"
                        data-feather="plus"></i>Ajouter banque</a>
            </div>
        </div>
                ...
                <div class="intro-y box p-5">
                    <form action="{{ route('banques.update', $banque)}}" method="POST">
                        ...
                        <div class="m-2 mb-3">
                            ...
                            <input id="crud-form-1" type="text" name="nom" value="{{ $banque->nom }}"
                        ...
                        <div class="m-2 mb-3">
                            ...
                            <input id="crud-form-2" name="numero_compte" value="{{ $banque->numero_compte }}" type="number" class="form-control w-full @error('numero_compte') is-invalid @enderror"
                        ...
                        <div class="m-2 mb-3">
                            ...
                            <input id="crud-form-3" type="file" name="logo_banque" value="{{ $banque->logo_banque }}" class="form-control w-full @error('logo_banque') is-invalid @enderror"
