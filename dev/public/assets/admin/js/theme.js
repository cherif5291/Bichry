...
var totalSalesEcommerce = function totalSalesEcommerce() {
  ...
  if ($echartsLineTotalSalesEcomm) {
    ...
    // const facture = JSON.parse('{!! $DM  !!}');

    const Fm01 = JSON.parse('{!! $Fm01 !!}');
    const Fm02 = JSON.parse('{!! $Fm02 !!}');
    const Fm03 = JSON.parse('{!! $Fm03 !!}');
    const Fm04 = JSON.parse('{!! $Fm04 !!}');
    const Fm05= JSON.parse('{!! $Fm05 !!}');
    const Fm06 = JSON.parse('{!! $Fm06 !!}');
    const Fm07 = JSON.parse('{!! $Fm07 !!}');
    const Fm08 = JSON.parse('{!! $Fm08 !!}');
    const Fm09 = JSON.parse('{!! $Fm09 !!}');
    const Fm10 = JSON.parse('{!! $Fm10 !!}');
    const Fm11 = JSON.parse('{!! $Fm11 !!}');
    const Fm12 = JSON.parse('{!! $Fm12 !!}');
...
docReady(chartPieMesFactures);
docReady(chartPieMesDepenses);
