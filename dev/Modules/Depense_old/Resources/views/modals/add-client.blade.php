    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content shadow-lg">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{__('messages.add_a')}} Fournisseur</h5>
                <button type="button" class="btn" wire:click="closeExpressModal('client')" aria-label="Close">
            ...
            <form wire:submit.prevent='saveClient'>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            {{-- <div class="form-check">
                                <input class="form-check-input" id="client" type="radio" name="clientType" value="client" wire:model="clientType" checked  required/>
                                <label class="form-check-label" for="client">Client</label>
                              </div> --}}
                              <div class="form-check">
                                <input class="form-check-input" id="fournisseur" type="radio" name="clientType" value="fournisseur" wire:model="clientType" required/>
                                <label class="form-check-label" for="fournisseur">Fournisseur</label>
                              </div>
                              @error('clientType') <span class="text-danger">{{ $message }}</span> @enderror
                        </div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-md-4">
                            <label class="form-label" for="entreprise">Nom du fournisseur <span
                        ...
                        <div class="col-md-4">
                            ...
                            <input class="form-control" wire:model="email" id="email" type="email" />
                        ...
                        <div class="col-md-4">
                            <label class="form-label" for="telephone">{{__('messages.telephone')}} {{-- <span
                                    class="text-danger">*</span> --}}</label>
                            <input class="form-control" wire:model="telephone" id="telephone" type="tel"  />
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" wire:click="closeExpressModal('client')">
                        {{__('messages.cancel')}}
                    </button>
