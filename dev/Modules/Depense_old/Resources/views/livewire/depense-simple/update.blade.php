            ...
            <form wire:submit.prevent='update' method="POST" enctype="multipart/form-data">
                                                ...
                                                @if ($compte->comptes_comptable_id != null)
                                                    <tr style="padding: 0px !important; ">
                                                        <td style="margin-left: 0px !important; padding-left:0px !important">
                                                            <select class="form-select  cartArt" aria-label="Default select example" disabled>
                ...
                <div class="row mt-4 gx-3 col-md-12 d-flex justify-content-between mb-3">
                    ...
                    <div class="col-md-3 col-12">
                        ...
                        <button class="btn btn-primary mt-3" type="button" data-bs-toggle="modal" data-bs-target="#pjdepensesimple">{{__('messages.see_pj')}}</button>
                        <div class="modal fade" id="pjdepensesimple" data-bs-keyboard="false" data-bs-backdrop="static" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
