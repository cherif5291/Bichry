...
if (!function_exists('getDepenseDataBySession')) {
    function getDepenseDataBySession()
    {
        ...
        if (auth()->user()->role == "cabinet" && $Session) {
            ...
            $data = [
                'Depenses' => Depense::where('entreprise_id', $EntrepriseID)->orderBy('id', 'desc')->get(),
                ...
                'Articles' => Article::where('entreprise_id', $EntrepriseID)->orderBy('id', 'desc')->get(),
            ...
            $data = [
                ...
                'Articles' => Article::where('entreprise_id', auth()->user()->entreprise_id)->orderBy('id', 'desc')->get(),
