        ...
        <div class="row col-md-12 d-flex justify-content-between gx-3 mb-3">
            <div class="d-flex mb-4 justify-content-between">
                ...
                <div>
                    ...
                    <button class="btn btn-danger" type="button" wire:click.prevent="confirmDeleteFacture({{$idFacture}})" > <i id="trash" data-id="0"
                        class="fa fa-trash text-light trash"></i> {{__('messages.delete')}}
                    </button>
                ...
                <div class="modal fade" id="pjrecu" data-bs-keyboard="false" data-bs-backdrop="static" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg mt-6" role="document">
                        ...
                        <div class="modal-body  p-0 bg-light" >
                            ...
                            <div class="">
                                <iframe id="pj_facture_recu" src="{{$pieceJointe}}" width="100%" height="600px"> </iframe>
                            </div>
                        </div>
                        </div>
                    </div>
