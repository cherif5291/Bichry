...
{
    public $fournisseur, $date_paiement, $numero_cheque, $note, $fichier, $paiements_modalite_id, $type;
    ...
    {
        if ($nom == 'compte') {
            $this->emit('openExpressWithUpdate', 0, 'cheque', 'compte', 'add');
        }elseif ($nom == 'client') {
            $this->emit('openExpressWithUpdate', 0, 'cheque', 'client', 'add');
        }elseif ($nom == 'article') {
            $this->emit('openExpressWithUpdate', 0, 'cheque', 'article', 'add');
        }
    }
    ...
    public function save(Request $request)
    {
        ...
        $this->dispatchBrowserEvent('swal:modal',[
            'type' => 'success',
            'title' => 'Chèque Ajouté avec succès!',
            'text' => ''
        ]);
    ...
    public function render()
    {
        ...
        return view('depense::livewire.cheque.add', compact('data'));
    }
}
