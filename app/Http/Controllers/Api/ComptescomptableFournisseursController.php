...
class ComptescomptableFournisseursController extends Controller
{
    /**
     ...
     */
    public function index(Request $request, Comptescomptable $comptescomptable)
    {
        $this->authorize('view', $comptescomptable);

        $search = $request->get('search', '');

        $fournisseurs = $comptescomptable
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(Request $request, Comptescomptable $comptescomptable)
    {
