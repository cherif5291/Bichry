    ...
    <div class="cd-popup-container">
        <div class="card-body ">
            <form wire:submit.prevent='update' method="POST" enctype="multipart/form-data">
                ...
                <div class="row col-md-12 d-flex justify-content-between gx-3 mb-3">
                    <div class="d-flex mb-4 justify-content-between">
                        <div class="col-md-5 d-flex justify-content-start">
                            <h4>{{__('messages.vendor_credit')}} {{__('messages.no')}}</h4>
                        ...
                        <div>
                            ...
                            <button class="btn btn-danger" type="button" wire:click.prevent="confirmDeleteFacture"> <i
                                    id="trash" data-id="0" class="fa fa-trash text-light trash"></i>
                                {{__('messages.delete')}}
                            </button>
                ...
                <input hidden type="text" wire:model="type" value="credit">
                ...
                <div class="row gx-3 col-md-12 d-flex justify-content-between  mb-3">
                    <div class="col-md-2 col-6">
                        <label class="form-label ls text-uppercase text-600 fw-semi-bold mb-0 fs--1"
                            for="fournisseur">{{__('messages.vendors')}}/{{__('messages.costumer')}}</label>
                ...
                <div class="row gx-3 col-md-12 d-flex justify-content-between  mb-3">
                    <div class="col-md-2 col-6">
                        ...
                        <input class="form-control datetimepicker"
                            wire:model="date_paiement" required id="date_paiement" />
                    ...
                    <div class="col-md-2 col-6">
                        ...
                        <input class="form-control" id="reference" wire:model="reference" type="number" />
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="heading1">
                                <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                    ...
                                    aria-controls="collapse1">{{__('messages.accounting_account')}} </button>
                            </h2>
                                        ...
                                        <table id="credit-four-table" class="table table-striped border-bottom">
                                            <thead class="light">
                                                <tr class="bg-line-chart-gradient text-white dark__bg-1000">
                                                    ...
                                                    <th class="border-0" hidden>{{__('messages.amount_without_taxe')}}
                                                    </th>
                                                ...
                                                <tr style="padding: 0px !important; ">
                                                    <td style="margin-left: 0px !important; padding-left:0px !important">
                                                        <select class="form-select mb-3 cartArt" aria-label="Default select example" disabled>
                                                            ...
                                                            <option value="{{$CompteComptable->id}}" {{ $CompteComptable->id == $article->comptes_comptable_id ?
                                                                'selected' : ''}}>
                                                    ...
                                                    <td>
                                                        <button wire:click.prevent="confirmDeleteCompte({{ $article->id }})" class="btn btn-round">
                ...
                <div class="row mt-4 gx-3 col-md-12 d-flex justify-content-between mb-3">
                    <div class="col-md-3 col-12">
                        <div class="mt-2">
                            ...
                            <textarea wire:model="note" id="" class="form-control" cols="30" id="note"
                                rows="4"> </textarea>
                        ...
                        <div class="modal fade" id="creditFournisseurPieceJoint" data-bs-keyboard="false" data-bs-backdrop="static" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg mt-6" role="document">
                                ...
                                <div class="modal-body  p-0 bg-light" >
                                    ...
                                    <div class="">
                                        <iframe id="pj_depense_creditFournisseur" src="{{$pieceJointe}}" width="100%" height="600px"> </iframe>
                                    </div>
                                </div>
                                </div>
                            </div>
                            ...
                            <table class="table table-sm table-borderless fs--1 text-end">
                                <tr>
                                    ...
                                    <td class="fw-semi-bold text-light total_sans_taxe">
                                        <div class="input-group mb-3">
                                            <input class="form-control inputwire inputwireTextWhite" disabled
                                                wire:model='total_sans_taxe' type="text" />
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <th class="text-light taxe_form">{{__('messages.taxe_amount')}}
                                        ({{getCurrency()->sigle}}):</th>
                                    <td class="fw-semi-bold taxe_value text-light">
                                        <div class="input-group mb-3">
                                            <input class="form-control inputwire inputwireTextWhite" disabled
                                                wire:model='taxe' type="text" />
                                        </div>
                                    </td>
                                </tr>

                                <tr class="border-top text-light border-top-2 fw-bolder  d-non">
                                    <th class="text-light">{{__('messages.amount_to_paye')}} ({{getCurrency()->sigle}}):
                                    </th>
                                    <td class="total_ttc text-light">
                                        <div class="input-group mb-3">
                                            <input class="form-control inputwire inputwireTextWhite" disabled
                                                wire:model='total' type="text" />
                                        </div>
                                    </td>
                                </tr>
                            </table>
