                                ...
                                <div class="accordion-body">
                                    <div class="table-responsive scrollbar mt-4 fs--1">
                                        <table id="credit-four-table" class="table table-striped border-bottom">
                                            ...
                                            <tbody id="credit-categorie-table" style="padding: 0px !important; margin: 0px !important">
                    ...
                    <div class="col-md-3 col-12 bg-line-chart-gradient">
                        <div class="col-auto mt-3">
                            <table class="table table-sm table-borderless fs--1 text-end">
                                <tr>
                                    <th class="text-start text-light">{{__('messages.sub_total')}} ({{getCurrency()->sigle}}):</th>
                                ...
                                <tr>
                                    <th class="text-start text-light taxe_form">{{__('messages.taxe_amount')}}
