...
class DepenseController extends Controller
{
    ...
    public function addNewCompteComptable($data)
    {
        ...
        $Comptescomptable->fk_sous_type_cpt_comptable=$data["fk_sous_type_cpt_comptable"];
        $Comptescomptable->fk_type_cpt_comptable=$data["fk_type_cpt_comptable"];
            ...
            if (count($data['rowCompte']) > 0) {
                ...
                foreach ($compte_comptable as $key => $n) {
                    if ($compte_comptable[$key]['compte_comptable_id'] != null || $compte_comptable[$key]['compte_comptable_id'] != '') {
                        ...
                        $DepensePanier->montant = $compte_comptable[$key]['montant'];
