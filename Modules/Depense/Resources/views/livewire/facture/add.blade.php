            ...
            <form wire:submit.prevent='save' method="POST" enctype="multipart/form-data">
                ...
                <div class="row gx-3 col-md-12 d-flex justify-content-between mb-3">
                    <div class="col-md-4 col-6">
                        ...
                        <button class="col-md-5 addbtn text-light btn btn-sm bg-line-chart-gradient" wire:click.prevent="openModalExpress('client')"><span class="fas fa-plus me-1" data-fa-transform="shrink-3"></span>Ajouter Fournisseurs</button>
                          </div>
                    </div>
                                    ...
                                    <table class="table table-striped border-bottom">
                                        ...
                                        <tbody  style="padding: 0px !important; margin: 0px !important">
                                            ...
                                            <tr style="padding: 0px !important; ">
                                                ...
                                                <td>
                                                    <input class="form-control montant" wire:model="rowCompte.{{$index}}.montant"
