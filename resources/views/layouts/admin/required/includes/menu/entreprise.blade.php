        ...
        <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
            ...
            @if (Auth::user()->role == "cabinet" && $Session == 0 )
               ...
               <!-- @if ($ModuleEntreprise->where('module_id', 6)->first() && Auth::user()->habilitation->fonctionnalites->where('module_id', 6)->first()->voir == "yes")
                ...
                <a class="nav-link" href="https://bilan-pro.com/depenses" role="button" aria-expanded="false">
                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                ...
                <a class="nav-link" href="{{route('entreprise.inventaire.stocks')}}" role="button" aria-expanded="false">
                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                class="fa fa-clipboard"></span></span><span class="nav-link-text ps-1">{{__('messages.inventory_management')}}</span>
                    </div>
                </a>
                @endif
