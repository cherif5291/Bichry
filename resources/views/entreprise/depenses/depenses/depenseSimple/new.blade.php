            ...
            <div class="row col-md-12 d-flex justify-content-between gx-3 mb-3">
                <div class="col-md-6">
                  ...
                  <select class="form-select mb-3" name="fournisseur" type="text" >
                    ...
                    <option value="id_fournisseur" selected> nom_fournisseur</option>
              ...
              <div class="row gx-3 col-md-12 d-flex justify-content-between mb-3">
                <div class="col-md-6">
                  <label class="form-label ls text-uppercase text-600 fw-semi-bold mb-0 fs--1" for="paiementsource_id">Source de paiement</label>
                  <select class="form-select mb-3" name="paiementsource_id" id="paiementsource_id" aria-label="Default select example">
                    @foreach ($SourcesPaiement as $source)
                    <option  value="{{$source->id}}"  @if ($Depense->paiementsource_id == $source->id) selected @endif>({{$source->type}})  {{$source->nom}}</option>
                    @endforeach
                ...
                <div class="col-md-4">
                    <label class="form-label ls text-uppercase text-600 fw-semi-bold mb-0 fs--1" for="date_facturation">Date de Paiement</label>
                    <input class="form-control datetimepicker" name="date_facturation" id="date_facturation" value=" @if ($DepenseSimple){{$DepenseSimple->date_paiement}}  @endif"   type="text" />
                </div>
              ...
              <div class="row gx-3 col-md-12 d-flex justify-content-between  mb-3">
                ...
                <div class="col-md-4">
                  ...
                  <select class="form-select mb-3" name="paiements_mode_id" id="paiements_mode_id" aria-label="Default select example">
                    @foreach ($ModePaiements as $modeP)
                    <option value="{{$modeP->id}}"  @if ($DepenseSimple) @if ($DepenseSimple->paiements_mode_id === $modeP->id) selected @endif @endif  >{{$modeP->nom}}</option>
                    @endforeach
                  </select>
                </div>

                <div class="col-md-4">
                    <label class="form-label ls text-uppercase text-600 fw-semi-bold mb-0 fs--1" for="reference">Nº réference</label>
                    <input class="form-control" id="reference" name="reference" type="text" value=" @if ($DepenseSimple) {{$DepenseSimple->reference}} @endif" />
                  </div>
              </div>
              <div class="row gx-3 col-md-12 d-flex justify-content-between mb-3">
                ...
                <div class="col-md-8">
                    ...
                    <textarea name="note" id="" class="form-control" cols="30" id="note" rows="4"> @if ($DepenseSimple) {{$DepenseSimple->note}} @endif</textarea>
                </div>
                <div class="col-md-4">
                   <div>
