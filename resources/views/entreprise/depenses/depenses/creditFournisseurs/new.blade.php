            ...
            <div class="row col-md-12 d-flex justify-content-between gx-3 mb-3">
              ...
              <div class="row gx-3 col-md-12 d-flex justify-content-between  mb-3">
                ...
                <div class="col-md-3">
                    ...
                    <input class="form-control datetimepicker" name="date_paiement" required id="date_paiement" value=" @if ($CreditFournisseur){{$CreditFournisseur->date_paiement}}  @endif"   type="date" />
                </div>
                <div class="col-md-3">
