    ...
    <div class="col-span-12 lg:col-span-12 xxl:col-span-12">
        ...
        <div class="intro-y flex flex-col-reverse sm:flex-row items-center">
            ...
            <div class="w-full sm:w-auto flex">
                <a href="{{route('caisses.create')}}" class="btn btn-primary shadow-md mr-2"><i class="w-4 h-4 mr-2"
                        data-feather="plus"></i>Ajouter caisse</a>
            </div>
        </div>
        ...
        <div class="intro-y grid grid-cols-12 gap-3 sm:gap-12 mt-5">
            <div class="intro-y col-span-12 lg:col-span-6">
                ...
                <div class="intro-y box p-5">
                    <form action="{{ route('caisses.update',$caisse->id)}}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="m-2 mb-3">
                            <label for="crud-form-1" class="form-label">Nom <span class="text-danger" style="color: red">*</span></label>
                            <input id="crud-form-1" type="text" name="nom" value="{{ $caisse->nom }}"
                        ...
                        <div class="m-2 mb-3">
                            ...
                            <input id="crud-form-2" name="solde" value="{{ $caisse->solde }}" type="number" class="form-control w-full @error('numero_compte') is-invalid @enderror"
