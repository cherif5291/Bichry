            ...
            <div class="row col-md-12 d-flex justify-content-between gx-3 mb-3">
                <div class="col-md-6">
                  ...
                  <select class="form-select mb-3" name="fournisseur" id="fournisseur" aria-label="Default select example">
                    ...
                    <option  @if ($Facture) @if ($Facture->fournisseur_id === $fournisseur->id) selected @endif @endif  value="{{$fournisseur->id}}">{{$fournisseur->entreprise}}</option>
                    @endforeach
                  </select>
                </div>
                <div class="col-md-2">
              ...
              <div class="row gx-3 col-md-12 d-flex justify-content-between mb-3">
                <div class="col-md-6">
                  <label class="form-label ls text-uppercase text-600 fw-semi-bold mb-0 fs--1" for="adresse_facturation">Adresse Postale</label>
                ...
                <div class="col-md-4">
                  <label class="form-label ls text-uppercase text-600 fw-semi-bold mb-0 fs--1" for="numero_facture">Nº de la facture à payer</label>
              ...
              <div class="row gx-3 col-md-12  mb-3">
                ...
                <div class="col-md-4">
                    ...
                    <input class="form-control" name="date_facturation" id="date_facturation" value=" @if ($Facture){{$Facture->date_facturation}}  @endif"   type="date" />
                </div>
                <div class="col-md-4">
                    <label class="form-label ls text-uppercase text-600 fw-semi-bold mb-0 fs--1" for="echeance">Date d'échéance</label>
                    <input class="form-control" name="echeance" id="echeance"  type="date" />
                </div>
              ...
              <div class="row gx-3 col-md-12 d-flex justify-content-between mb-3">
                ...
                <div class="col-md-8">
                    ...
                    <textarea name="note" id="" class="form-control" cols="30" id="note" rows="4"> @if ($Facture) {{$Facture->message}} @endif</textarea>
                </div>
                <div class="col-md-4">
                   <div>
      ...
      <div class="card h-100">
        ...
        <div class="card-body bg-light">
          ...
          <div class="d-flex justify-content-between fs--1 mb-1 text-danger">
            <p class="mb-0">Taxe</p><span>{{$DepensePaniers->where('depense_id', $Depense->id)->sum('montant_taxe')}} Fcfa*</span>
          </div>
          <div class="d-flex justify-content-between fs--1 mb-1">
            <p class="mb-0">Sous-total</p><span>{{$DepensePaniers->where('depense_id', $Depense->id)->sum('total')}} Fcfa*</span>
          </div>
          <hr />
          <h5 class="d-flex justify-content-between"><span>SOLDE À PAYER</span><span>{{$DepensePaniers->where('depense_id', $Depense->id)->sum('total')}} Fcfa*</span></h5>
