...
<div id="devisPopup" class="cd-popup ex3 bg-light fixed-top" role="alert">
    @include('entreprise.commerciale.factures.devis.devispopup')
</div>

<div id="PaiementRecuPopup" class="cd-popup ex3 bg-light fixed-top" role="alert">
    @include('entreprise.commerciale.factures.devis.paiementdevis')
</div>
<div id="devis" class="cd-popup ex3 bg-light fixed-top" role="alert">
    @include('entreprise.commerciale.factures.devis.form')
                ...
                <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                    ...
                    <div class="btn-group" role="group">
                        ...
                        <div class="dropdown-menu" aria-labelledby="btnGroupVerticalDrop1">
                            ...
                            <a class="dropdown-item" href="#0" id="pop1btn" class="cd-popup-trigger"
                                onclick="openpopup('devis')">{{__('Devis')}}</a>
                        ...
                        <small>
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu dropdown-menu-end fixed-top">
                                    ...
                                    <a class="dropdown-item btn-edit-devis" devis-id="{{ $facture->id ?? '' }}" href="#0"
                                        class="cd-popup-trigger btn btn-success" onclick="openpopup('devisPopup')">
                                        <i class="fa fa-edit"></i> {{__('Devis')}}
                                    </a>
                                    @endif
                                    @else
...
@include('entreprise.commerciale.facture.devis.ajax')
