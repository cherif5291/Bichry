<div class="cd-popup-container">
    <div class="card-body ">
        ...
        <form action="{{route('entreprise.devis.depensedevisAdd')}}" method="POST" enctype="multipart/form-data">@csrf
            <div class="row col-md-12 d-flex justify-content-between gx-3 mb-3">
                <div class="d-flex mb-4 justify-content-between">
                    <h4>{{__('messages.invoice')}} {{__('messages.no')}} <span id="get_devis_number_commercial" style="color: red!important"></span></h4>
            ...
            <div class="row col-md-12 d-flex justify-content-start gx-3 mb-3">
                ...
                <div class="col-md-2 col-6 d-none d-md-block d-xl-block d-sm-block">
                   ...
                   <h3 id="amount_commercial_devis_pay">{{getCurrency()->sigle}}0.00 </h3>
                </div>
            </div>
            ...
            <div class="row gx-3 col-md-12 d-flex justify-content-between mb-3">
                ...
                <div class="col-md-2 col-6" >
                    ...
                    <select class="form-select mb-3" name="paiements_modalite_id" id="paiements_modalite_id_devis"
                        aria-label="Default select example">
                ...
                <div class="col-md-2 col-6" >
                    ...
                    <input class="form-control datetimepicker" name="date_facturation"
                        data-options='{"disableMobile":true}' id="date_facturation_devis"
                ...
                <div class="col-md-2 col-6" >
                    ...
                    {{-- <input class="form-control datetimepicker" name="echeance" id="echeance_devis"
                        type="text" /> --}}
                    <input class="form-control datetimepicker" data-options='{"disableMobile":true}' name="echeance"
                        id="echeance_devis" type="text" />
                </div>
                ...
                <div class="col-md-2 col-6" >
                    ...
                    <input class="form-control" id="numero_devis" name="numero_devis" type="number" />
                </div>
                ...
                <div class="col-md-12">
                    <div class="table-responsive scrollbar mt-4 fs--1">
                        ...
                        <input value="{{$Articles}}" type="hidden" id="articles_devis_depense" />
                        <input value="{{$Taxes}}" type="hidden" id="taxe_devis_depense" />
                    </div>
