        ...
        <form action="{{route('entreprise.facture.changeFactureStatus', $Facture->id)}}" method="POST">@csrf
                <div class="row col-md-12 d-flex justify-content-between gx-3 mb-3">
                    ...
                    <select class="form-select mb-3" name="fournisseur" id="fournisseur" aria-label="Default select example">
                        ...
                        <option  @if ($Facture->client_id == $client->id) selected @endif  value="{{$client->id}}">{{$client->entreprise}}</option>
                        @endforeach
                    </select>
                    </div>
                    <div class="col-md-4">
              ...
              <div class="row gx-3 col-md-12 d-flex justify-content-between mb-3">
                ...
                <div class="col-md-4">
                    ...
                    <select class="form-select mb-3" name="paiements_modalite_id" aria-label="Default select example">
                      ...
                      <option @if ($Facture)@if ($Facture->paiements_modalite_id === $Modalite->id) selected @endif @endif value="{{$Modalite->id}}">{{$Modalite->nom}}</option>
                      @endforeach
                    </select>
                  </div>
            ...
            <div class="col-md-4">
                    ...
                    <input class="form-control datetimepicker" name="date_facturation" data-options='{"disableMobile":true}' id="date_facturation" value=" @if ($Facture){{$Facture->date_facturation}}  @endif"   type="text" />
                </div>
                <div class="col-md-4">
                    <label class="form-label ls text-uppercase text-600 fw-semi-bold mb-0 fs--1" for="echeance">Date d'échéance</label>
                    <input class="form-control datetimepicker" name="echeance" id="echeance"  type="text" value=" @if ($Facture){{$Facture->echeance}}  @endif" />
                </div>

                <div class="col-md-4">
                    <label class="form-label ls text-uppercase text-600 fw-semi-bold mb-0 fs--1" for="numero_facture">Nº de la facture</label>
                    <input class="form-control" id="numero_facture" name="numero_facture" type="text" value=" @if ($Facture) {{$Facture->numero_facture}} @endif" />
            </div>
